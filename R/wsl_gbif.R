...
#' 'datasetKey'.
#' 
#' @param sp_name Object of class 'character'. Scientific name to run an online search
#' (i.e. with GBIF-API) for species observations. Works also for genus and higher taxa
#' levels.
#' @param conf_match Object of class 'numeric' from 0 to 100. Determine the confidence
...
#' @param grain Object of class 'numeric'. Specify in meters the study resolution. Used to
...
#' @param duplicates TRUE or FALSE. Should duplicated records be kept?
#' @param absences TRUE or FALSE. Should absence records be kept?
#' @param no_xy TRUE or FALSE. Default is FALSE i.e. only records with coordinates are
#' downloaded. If TRUE, only records with no coordinates are downloaded.
#' @param basis Object of class 'character'. Which basis of records should be selected?
...
#' @param add_infos Vector of character IDs which would add to the default output information.
...
#' @param identic_xy TRUE or FALSE. Should records with identical xy be kept?
#' @param wConverted_xy TRUE or FALSE. Should incorrectly lon/lat converted xy be kept?
#' Uses `cd_ddmm` from 'CoordinateCleaner' R package.
#' @param centroids TRUE or FALSE. Should species records from raster centroids be kept?
#' Uses `cd_round` from 'CoordinateCleaner' R package.
#' @param ntries In case of failure from GBIF server or within the rgbif package, how many
