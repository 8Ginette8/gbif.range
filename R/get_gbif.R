...
#' test2 = get_gbif("Cypripedium calceolus", geo = shp.lonlat, grain = 100, add_infos = c("issue"))
#' plot(shp.lonlat)
...
#' test3 = get_gbif("Ailuropoda melanoleuca", grain = 100000 , duplicates = TRUE,
...
#' test4 = get_gbif("Phascolarctos cinereus", grain = 1000,
