...
#' @seealso \code{\link{get_gbif}}() to produce the \code{getGBIF} objects
#' used as input here; the \pkg{rgbif} package for more general workflows to
#' create GBIF derived datasets and DOIs.
