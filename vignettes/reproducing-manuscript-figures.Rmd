...
```{r fig-1a-left, echo = FALSE, out.width = "50%"}
...
```{r fig-1a-right, echo = FALSE, out.width = "50%"}
...
```{r fig-2a, echo = FALSE, out.width = "50%"}
...
```{r fig-2b, echo = FALSE, out.width = "50%"}
...
```{r fig-2c, echo = FALSE, out.width = "50%"}
...
```{r fig-2d, echo = FALSE, out.width = "50%"}
...
```{r fig-3-maps, echo = FALSE, out.width = "50%", fig.show = "hold"}
...
```{r fig-3-scatter, echo = FALSE, out.width = "80%", fig.show = "hold"}
knitr::include_graphics(c(
