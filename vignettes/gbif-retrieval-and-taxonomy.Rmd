...
- or a downloaded GBIF export that will later be processed with the disk-based batch workflow described in Part 3: `vignette("large-downloaded-gbif-tables", package = "gbif.range")`.
...
sequence of post-download filters, custom and via `CoordinateCleaner`
(Zizka et al. 2019) in one function. The retrieval workflow originates from
Chauvier et al. (2021, *Ecological Monographs*).
