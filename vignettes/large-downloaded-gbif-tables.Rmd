...
2001; The Nature Conservancy 2009). More
generally, any polygon object with a named character column works as `ecoreg`,
and `make_ecoreg()` accepts any spatially structured raster as input — not
only climate layers. See Part 1 for full details on both.
