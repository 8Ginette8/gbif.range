...
Finally, also note that for **faster process or to overcome some potential RAM crash of the function**, *get_range* can be used with a **sub-sample of GBIF observations**.
