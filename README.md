...
Finally, also note that for **faster process or to overcome potential RAM crash of the function** in the case of too many records, *get_range* can be used with a **sub-sample of species observations**.
