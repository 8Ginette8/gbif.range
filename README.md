...
[![R-CMD-check-all-macos](https://github.com/8Ginette8/gbif.range/actions/workflows/R-CMD-check-all.yml/badge.svg?branch=main&event=push)](https://github.com/8Ginette8/gbif.range/actions/workflows/R-CMD-check-all.yml)
